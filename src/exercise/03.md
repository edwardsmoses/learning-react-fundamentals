...
When using the spread prop, my first attempt was `<div {...props}></div>`. 
Obviously, this didn't work out, as in some way, I was overriding the children property from the props object.
Pretty interesting..
