...
Learnt how Babel compiles JSX to Javascript. Pretty neat.
Also reinforced my understanding on how React uses the inside of an element as the children automatically.

How so:
When using the spread prop, my first attempt was `<div {...props}></div>`. Obviously, this didn't work out, as in some way, I was overriding the children property from the props object.
Pretty interesting..
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=edwardsmoses3%40gmail.com).
