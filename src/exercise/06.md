...
I got a better understanding of what Controlled Inputs and Uncontrolled Inputs meant...
**Uncontrolled Inputs** are inputs whose values are managed by the browser... and to get their values, React has to get the Info from the DOM
**Controlled INputs** on the other hand, are inputs whose values are managed by React (mostly using useState, or in some cases form libraries)
And why it **matters** to React..
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=06%3A%20Forms&em=edwardsmoses3%40gmail.com).
