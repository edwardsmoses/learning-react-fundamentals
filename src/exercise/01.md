...
Completed Exercise 1. The Only thing I learnt here was the fact that the document can't be accessed before initialization (whatever that means).
I also learnt how to access the Body Element using Javascript.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=edwardsmoses3%40gmail.com).
